	...
	renderSetupStep: function () {
		return <div className="mt8 clearfix">
			<div className="px4 md-col md-col-6">
				...
				<p>
					OhCrash client is a universal module, the same library works in Node.js and browsers.
				</p>
			</div>
	...
	renderErrorStep: function () {
		return <div className="mt8 clearfix">
			...
			<div className="px4 md-col md-col-6">
				...
				<p>
					OhCrash client tracks <Link to="/docs#uncaught-exceptions">uncaught exceptions</Link> and <Link to="/docs#unhandled-rejections">unhandled rejections</Link> in Node.js
					and <Link to="/docs#errors-in-browsers">global errors</Link> via <code>window.onerror</code> in browsers.
				</p>
			</div>
		</div>;
	},
	...
	renderIssueStep: function () {
		return <div className="mt8 clearfix">
			<div className="px4 md-col md-col-6">
				...
				<p>
					Only one issue will be opened for one unique error, so that your repository
					won't be filled up with hundreds of duplicate issues.
				</p>
			</div>
